...
use Teapot::Bot::Object::MessageReactionUpdated ();
...
sub _process_message {
    ...
    $update = Teapot::Bot::Object::MessageReactionUpdated->create_from_hash($item->{message_reaction}, $self) if $item->{message_reaction};
